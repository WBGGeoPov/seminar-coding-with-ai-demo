...
save "${temp}/nat_pov_gap.dta", replace
...
save "${temp}/nat_gini.dta", replace
...
save "${temp}/nat_theil.dta", replace

// Merge all national aggregates
use "${temp}/nat_n.dta", clear
merge 1:1 year using "${temp}/nat_hh.dta", nogenerate
merge 1:1 year using "${temp}/nat_age.dta", nogenerate
merge 1:1 year using "${temp}/nat_lit.dta", nogenerate
merge 1:1 year using "${temp}/nat_wel.dta", nogenerate
merge 1:1 year using "${temp}/nat_pov_rate.dta", nogenerate
merge 1:1 year using "${temp}/nat_pov_gap.dta", nogenerate
merge 1:1 year using "${temp}/nat_gini.dta", nogenerate
merge 1:1 year using "${temp}/nat_theil.dta", nogenerate
...
export delimited "${output}/national_summary.csv", replace

di as result _n "National aggregates calculated and saved to national_summary.csv"
